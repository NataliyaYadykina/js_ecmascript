...
Реализуйте класс Employee (сотрудник),
...
Убедитесь, что вы используете приватные поля
и статическое поле в соответствии с описанием.
*/
...
class ZooAnimal {
    ...
    constructor(name, age, gender) {
        ...
        if (age > ZooAnimal.#MAX_AGE) {
            throw new Error(`(in constructor) Age ${age} is too high`);
        } else if (age < 0) {
            throw new Error(`(in constructor) Age ${age} is too low`);
        }
    ...
    changeAge = (newAge) => {
        if (newAge > ZooAnimal.#MAX_AGE) {
            throw new Error(`(in changeAge) Age ${newAge} is too high`);
        } else if (newAge < 0) {
            throw new Error(`(in changeAge) Age ${newAge} is too low`);
        }
        this.#age = newAge;
    }
...
const dog = new ZooAnimal("Rex", 2, "male");
console.log(dog.getName());
dog.changeName("Bobik");
console.log(dog.getName());
...
// const dog1 = new ZooAnimal("Rex", -2, "male"); // Uncaught Error: (in constructor) Age -2 is too low
// const dog2 = new ZooAnimal("Rex", 35, "male"); // Uncaught Error: (in constructor) Age 35 is too high

// dog.changeAge(-1); // Uncaught Error: (in changeAge) Age -1 is too low
// dog.changeAge(50); // Uncaught Error: (in changeAge) Age 50 is too high

console.log(dog.name); // undefined
// console.log(dog.#name); // Uncaught SyntaxError: Private field '#name' must be declared in an enclosing class